...
function cleanSite(site = {}) {
  ...
  /*
    Existing Theater Hub DBs can use slightly
    different column names for Site fields.

    v10/v11 frontend sends the normalized Site data.
  */
  ...
  async function handler(
    ...
    try {
      ...
      /* =====================================================
         ...
         IMPORTANT:
         Accept BOTH names so frontend versions
         v5 ~ v11 all work.
      ===================================================== */
      ...
      /* =====================================================
         UPDATE SITE
         KML / KMZ duplicate → Update existing
      ===================================================== */
